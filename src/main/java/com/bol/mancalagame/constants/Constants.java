package com.bol.mancalagame.constants;

public class Constants {

	public static final int leftBigPitId = 14;
    public static final int totalPits = 14;
    public static final int rightBigPitId = 7;
    public static final int emptyStone = 0;
    
    public static final Integer NUMBER_OF_PITS_PER_PLAYER = 6;
    public static final Integer defaultGameBoardSize = 14;
